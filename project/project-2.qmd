...
[^1]: Never built an R package before?
...
-   Week 1 of project (week of Mar 18): Pick a focus for your project, developing your project proposal, and set up the structure for your repository.

-   Week 2 of project (week of Mar 25): Finalize your project proposal + Conduct peer review on project proposals, and optionally, submit in an updated version of your proposal.

-   Week 3 of project (week of Apr 1): Continue working on your project, incorporating feedback from proposals.

-   Week 4 of project (week of Apr 8): Continue working on your project.

-   Week 5 of project (week of Apr 15): Continue working on your project.

-   Week 6 of project (week of Apr 22): Conduct peer code review, and incorporate feedback from the review.

-   Week 7 of project (week of Apr 29 - finals week): Present projects and turn in final write-up.

## Due dates

-   Proposals for peer review: Wed, Mar 27 at 1 pm
-   Peer review of proposals: Wed, Mar 27 in lab session
-   Revised proposals for instructor review: Fri, Mar 29 at 5 pm
-   Peer review of code: Wed, Apr 24 in lab session
-   Write-up and presentation: Wed, May 1 at 9 am
...
The peer reviews will be completed during the lab sessions as indicated above.
On those days teams will have access to the project repos of the teams whose work they're reviewing.
The first peer review will be of proposals and the second peer review will be of code and organization.
...
To do so, go to the *Issues* tab, click on the green *New issue* button on the top right, and then click on the green *Get started* button for the issue template titled *Proposal peer review* or *Code peer review*.
...
The peer review assignments for **proposal peer reviews** are **TO BE POSTED**:
...
p2_pr <- read_csv("project_2_peer_review_teams.csv")
gt(p2_pr)
```

The peer review assignments for **code peer reviews** are **TO BE POSTED**:
...
The limits are provided to help you, not to set stressful expectations.
...
You should create your presentation in a reproducible way, e.g., using Quarto.
...
The only rule is that it's built reproducibly using R.
...
But...
it should be organized in a logical way!

At a minimum each project should have an `index.qmd`.
...
[^6]: This relates to your contribution to the teamwork and how your team members evaluate this contribution.
...
-   Teamwork: You are to complete the assignment as a team.
    All team members are expected to contribute equally to the completion of this assignment and team evaluations will be given at its completion - anyone judged to not have sufficiently contributed to the final product will have their grade penalized.
    While different team members may have different backgrounds and abilities, it is the responsibility of every team member to understand how and why all code and approaches in the assignment work.
