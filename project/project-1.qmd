...
Each of your projects will have a website that looks like <https://vizdata-s24.github.io/project-1> **(TO DO: MAKE REPO/WEBSITE)**. You are not expected to change the styling of the website, but if you want to, you'll need to edit the `_quarto.yml` file in your repo. Feel free to google your way around it or ask on the discussion forum / office hours!
