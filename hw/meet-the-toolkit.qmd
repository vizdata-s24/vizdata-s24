...
## 2. Profiles in course tools

- Update your GitHub profile to show your real name and (ideally, but optionally) a recent photo of yours. 
If you prefer not to use your photo, that's fine, but please use some personalized avatar that's not the one GitHub randomly assigns to you.
...
Your code should go in `polling.qmd`.
Render, commit, and push your progress regularly to the GitHub repository.
