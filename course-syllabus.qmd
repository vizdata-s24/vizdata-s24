...
-   **Homework assignments**, due every other week (roughly), completed individually. Lowest homework assignment score is dropped.
    ...
    Homework assignments are due by 10 pm ET (beginning of class) on the indicated day on the [course schedule](https://www.vizdata.org/schedule.html).
...
-   Homework assignments: GitHub repositories will be closed to contributions at the deadline. If you need to submit your work late, send a DM on Slack to Eli Gnesin (our Head TA) to reopen your repository.
...
Regrade requests must be made within one week of when the assignment is returned, and must be typed up and submitted via email to the course Head TA (Eli Gnesin). These will be considered if points were tallied incorrectly or if you feel your answer is correct but it was marked wrong. No regrade will be made to alter the number of points deducted for a mistake. There will be no grade changes after the second project presentations. Note that during the regrade process your score could go up or go down or not change.
