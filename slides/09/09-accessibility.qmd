...
-   Projects:
    -   Peer evaluations – Look out for email from TEAMMATES
    -   Work on projects in lab tomorrow
-   Use of external resources / cohesive coding style
-   Reminder: Duke Community Standard
...
::: task
Find a colorblind friendly color palette other than viridis and those in the ggthemes packages. This could be an R package that offers a colorblind friendly color palette or it could be just a palette you find online. Apply it to the scatterplot you previously wrote alt text for.
:::
