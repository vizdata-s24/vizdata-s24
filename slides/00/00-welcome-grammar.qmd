...
<!-- -->
```
-   **✅ AI tools for code:** You may make use of the technology for coding examples on assignments; if you do so, you must explicitly cite where you obtained the code. Any recycled code that is discovered and is not explicitly cited will be treated as plagiarism. See the syllabus for guidelines for citing AI-generated content.
...
5.  Complete the readings -- to be posted
